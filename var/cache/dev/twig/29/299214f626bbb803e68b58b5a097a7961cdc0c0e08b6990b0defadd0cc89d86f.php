...
";
    ...
    {
        return array (  82 => 10,  78 => 9,  74 => 8,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    <section class=\"wrapper\">
        <div class=\"row\">
            <div class=\"col-lg-8 main-chart\">
            {{ form_start(form) }}
                Name : {{ form_widget(form.name, {'attr': {'class': 'form-control','placeholder':'Type the title'}}) }}
            {{ form_end(form) }}
            </div>
        </div>
    </section>
...
{% endblock %}", "Categories/add.html.twig", "C:\\wamp64\\www\\PFE\\templates\\Categories\\add.html.twig");
    }
}
