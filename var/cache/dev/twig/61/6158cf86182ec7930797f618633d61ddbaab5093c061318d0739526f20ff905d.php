...
class __TwigTemplate_3aa37540fc02b134a2862a53766b797d95614b6337978309555972c1ceac6b4d extends Template
{
    private $source;
    private $macros = [];
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "WebProfilerBundle:Collector:form.html.twig", "C:\\wamp64\\www\\PFE\\vendor\\symfony\\web-profiler-bundle/Resources/views/Collector/form.html.twig");
    }
}
