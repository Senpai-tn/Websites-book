...
ทีมงาน
',
    'resetting.check_email' => 'อีเมลถูกส่งไปให้คุณพร้อมกับลิงค์เพื่อคลิ๊กสำหรับตั้งรหัสผ่านใหม่ โดยลิงค์นี้จะมีอายุใช้ได้ %tokenLifetime% ชั่วโมง

หากคุณไม่ได้รับอีเมลกรุณาเช็คที่โฟลเดอร์สแปมหรือลองทำอีกครั้ง
',
