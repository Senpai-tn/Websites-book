...
$catalogue = new MessageCatalogue('vi', array (
  ...
  array (
    ...
    'registration.email.message' => 'Xin chào %username%!

Để hoàn tất kích hoạt tài khoản của bạn - vui lòng truy cập %confirmationUrl%.

Cám ơn.\'
',
    'resetting.check_email' => 'Một email đã được gởi đến cho bạn. Nó có chứa một liên kết kích hoạt bạn phải bấm vào để kích hoạt tài khoản của bạn.
...
',
    ...
    'resetting.flash.success' => 'Mật khẩu đã được thiết lập lại thành công',
    'resetting.email.subject' => 'Thiết lập lại mật khẩu',
    'resetting.email.message' => 'Xin chào %username%!
