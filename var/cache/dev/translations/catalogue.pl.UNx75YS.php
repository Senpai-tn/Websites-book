...
$catalogue = new MessageCatalogue('pl', array (
  ...
  array (
    ...
    'fos_user.username.already_used' => 'Taki użytkownik już istnieje. Podaj inną nazwę.',
    'fos_user.username.blank' => 'Podaj nazwę użytkownika',
    'fos_user.username.short' => 'Podaj dłuższą nazwę użytkownika',
    'fos_user.username.long' => 'Podaj krótszą nazwę użytkownika',
    'fos_user.email.already_used' => 'Taki użytkownik już istnieje. Podaj inny email.',
    'fos_user.email.blank' => 'Podaj email',
    'fos_user.email.short' => 'Podaj dłuższy email',
    'fos_user.email.long' => 'Podaj krótszy email',
    'fos_user.email.invalid' => 'Podaj prawidłowy email',
    'fos_user.password.blank' => 'Podaj hasło',
    'fos_user.password.short' => 'Podaj dłuższe hasło',
    'fos_user.password.mismatch' => 'Hasła nie pasują do siebie. Podaj dwa razy to samo hasło.',
    'fos_user.new_password.blank' => 'Podaj nowe hasło',
    'fos_user.new_password.short' => 'Podaj dłuższe hasło',
    'fos_user.current_password.invalid' => 'Podaj prawidłowe hasło',
    'fos_user.group.blank' => 'Podaj nazwę',
    'fos_user.group.short' => 'Podaj dłuższą nazwę',
    'fos_user.group.long' => 'Podaj krótszą nazwę',
    'fos_group.name.already_used' => 'Taka grupa już istnieje. Podaj inną nazwę.',
  ),
  'security' => 
  array (
  ...
  array (
    ...
    'registration.check_email' => 'Na adres %email% wysłano wiadomość e-mail z linkiem. Kliknij go, aby aktywować Twoje konto.',
    'registration.confirmed' => 'Gratulacje %username%, Twoje konto zostało aktywowane.',
    'registration.back' => 'Powrót do poprzedniej strony',
    'registration.submit' => 'Zarejestruj',
    'registration.flash.user_created' => 'Twoje konto zostało utworzone',
    'registration.email.subject' => 'Cześć %username%!',
