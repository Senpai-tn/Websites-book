...
$catalogue = new MessageCatalogue('mn', array (
  ...
  'FOSUserBundle' => 
  array (
    'group.edit.submit' => 'Бүлгийг шинэчлэх',
    'group.show.name' => 'Бүлгийн нэр',
    'group.new.submit' => 'Бүлэг үүсгэх',
    'group.flash.updated' => 'Бүлэг шинэчлэгдлээ.',
    'group.flash.created' => 'Бүлэг шинээр үүслээ.',
    'group.flash.deleted' => 'Бүлэг устгагдлаа.',
    'security.login.username' => 'Хэрэглэгчийн нэр',
    'security.login.password' => 'Нууц үг',
    'security.login.remember_me' => 'Намайг сана',
    'security.login.submit' => 'Нэвтрэх',
    'profile.show.username' => 'Хэрэглэгчийн нэр',
    'profile.show.email' => 'И-мэйл',
    'profile.edit.submit' => 'Шинэчлэх',
    'profile.flash.updated' => 'Хувийн мэдээлэл шинэчлэгдлээ.',
    'change_password.submit' => 'Нууц үгээ өөрчлөх',
    'change_password.flash.success' => 'Нууц үг өөрчлөгдлөө.',
    'registration.check_email' => 'И-мэйл %email% гэсэн хаяг руу илгээгдлээ. И-мэйлээр ирсэн баталгаажуулах холбоосоор орж эрхээ баталгаажуулна уу.
',
    'registration.confirmed' => 'Баяр хүргэе %username%, таны эрх баталгаажлаа.',
    'registration.back' => 'Өмнөх хуудас руу буцах.',
    'registration.submit' => 'Бүртгүүлэх',
    'registration.flash.user_created' => 'Хэрэглэгчийн эрх амжилттай үүслээ.',
    'registration.email.subject' => 'Тавтай морилно уу %username%!',
    'registration.email.message' => 'Сайн байна уу %username%!

Эрхээ баталгаажуулахын тулд - дараах холбоосоор орж баталгаажуулна уу %confirmationUrl%

Энэхүү баталгаажуулах холбоос ганцхан удаа ашиглагдах боломжтойг анхаарна уу.

Хүндэтгэсэн,
Багийн хамт олон.
',
    'resetting.check_email' => 'И-мэйл илгээгдлээ. И-мэйлээр ирсэн холбоосоор орж шинэ нууц үгээ авна уу.
Note: Шинэ нууц үг авах хүсэлтийг та %tokenLifetime% цагийн дотор нэг удаа явуулах боломжтой.

Хэрэв таньд и-мэйл ирээгүй бол спам хавтас дотроо шалгана уу эсвэл дахин шинээр оролдоно уу.
',
    'resetting.request.username' => 'Хэрэглэгчийн нэр эсвэл и-мэйл',
    'resetting.request.submit' => 'Шинээр нууц үг авах',
    'resetting.reset.submit' => 'Нууц үгээ өөрчлөх',
    'resetting.flash.success' => 'Шинэ нууц үг авах хүсэлт амжилттай.',
    'resetting.email.subject' => 'Шинээр нууц үг авах',
    'resetting.email.message' => 'Сайн байна уу %username%!

Шинэ нууц үг авах бол - дараах холбоосоор орно уу %confirmationUrl%

Хүндэтгэсэн,
Багийн хамт олон.
',
    'layout.logout' => 'Гарах',
    'layout.login' => 'Нэвтрэх',
    'layout.register' => 'Бүртгүүлэх',
    'layout.logged_in_as' => '%username% -ээр нэвтрэх',
    'form.group_name' => 'Бүлгийн нэр',
    'form.username' => 'Хэрэглэгчийн нэр',
    'form.email' => 'И-мэйл',
    'form.current_password' => 'Одоогийн нууц үг',
    'form.password' => 'Нууц үг',
    'form.password_confirmation' => 'Нууц үгээ давтана уу',
    'form.new_password' => 'Шинэ нууц үг',
    'form.new_password_confirmation' => 'Шинэ нууц үгээ давтана уу',
  ),
));
